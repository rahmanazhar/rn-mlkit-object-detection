package com.rnmlkitobjectdetection
...
class RNMLKitObjectDetectionModule(reactContext: ReactApplicationContext) : ReactContextBaseJavaModule(reactContext) {

  override fun getName(): String {
    return "RNMLKitObjectDetection"
  }
